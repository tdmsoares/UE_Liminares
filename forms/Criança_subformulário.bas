...
Begin Form
    ...
    Filter ="Criança.Nome Like 'maria souza correia*'"
    OrderBy ="[Criança_subformulário].Name"
    RecSrcDt = Begin
        0x393d027a8f60e440
    End
    RecordSource ="SELECT [Criança].[Código], [Criança].[Nome], [Criança].[Nascimento], [Criança].["
        "Status], [Criança].[Processo] FROM Criança; "
